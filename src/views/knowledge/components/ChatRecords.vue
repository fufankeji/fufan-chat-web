...
const knowledge_bases = ref<string[]>([]);
const knowledge_bases_name = ref<string>("");
    ...
    <div class="main-center">
        ...
        <div>
            <div class="chat-input-top">
                ...
                <GPTModelSelect />
                <el-select style="width: 160px" v-model="knowledge_bases_name">
                    <el-option v-for="item in knowledge_bases" :label="item" :key="item" :value="item" />
                </el-select>
            </div>
